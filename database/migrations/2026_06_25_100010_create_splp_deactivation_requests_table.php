...
return new class extends Migration
{
    ...
    {
        Schema::create('splp_deactivation_requests', function (Blueprint $table) {
            $table->id();
            ...
            // Objek yang dinonaktifkan/dicabut
            $table->enum('target_type', ['service', 'consumer'])->default('service');
            ...
            $table->enum('jenis_tindakan', ['nonaktif', 'cabut'])->default('nonaktif');
            $table->text('alasan');
    ...
    {
        Schema::dropIfExists('splp_deactivation_requests');
    }
};
