...
<div class="container mx-auto px-4">
    <div class="mb-6 flex items-center justify-between">
        <h1 class="text-2xl font-bold text-purple-700">Pendaftaran Akun Tanda Tangan Elektronik</h1>
        <a href="{{ route('user.tte.registration.create') }}"
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                        <a href="{{ route('user.tte.registration.show', $item) }}"
                            class="text-purple-600 hover:text-purple-800 font-semibold">
                            Detail →
                        </a>
                        @if($item->status === 'selesai')
                        <a href="{{ route('user.tte.registration.survey', $item->id) }}"
