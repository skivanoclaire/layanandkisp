...
@section('title', '- Daftar Permohonan Pembaruan Sertifikat TTE')
@section('header-title', 'Permohonan Pembaruan Sertifikat TTE')

@section('content')
<div class="container mx-auto px-4">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Permohonan Pembaruan Sertifikat TTE Saya</h1>
        <a href="{{ route('user.tte.certificate-update.create') }}" class="bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg font-semibold transition">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 text-sm font-medium">
                            <a href="{{ route('user.tte.certificate-update.show', $request) }}" class="text-blue-600 hover:text-blue-900">
                                Detail
                            </a>
                            @if($request->status === 'selesai')
                            <a href="{{ route('user.tte.certificate-update.survey', $request->id) }}"
