...
@section('title', '- Permohonan Reset Passphrase TTE')
@section('header-title', 'Permohonan Reset Passphrase TTE')

@section('content')
<div class="container mx-auto px-4 max-w-4xl">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-700">Permohonan Reset Passphrase Tanda Tangan Elektronik/Digital Provinsi Kalimantan Utara</h1>
    </div>
    ...
    <form action="{{ route('user.tte.passphrase-reset.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div class="flex items-start">
                ...
                <div class="text-sm text-blue-800">
                    ...
                    <p>Setelah submit, link reset passphrase akan dikirimkan ke email @kaltaraprov.go.id yang telah didaftarkan di BSrE (Balai Sertifikasi Elektronik).</p>
                </div>
            </div>
        </div>
