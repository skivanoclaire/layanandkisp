...
@section('title', '- Pendaftaran VPN')
@section('header-title', 'Pendaftaran VPN')

@section('content')
<div class="container mx-auto px-4 max-w-6xl">
    <div class="mb-6 flex items-center justify-between">
        <h1 class="text-2xl font-bold text-purple-700">Daftar Permohonan Pendaftaran VPN</h1>
        <a href="{{ route('user.vpn.registration.create') }}"
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($requests as $req)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap">
                                <a href="{{ route('user.vpn.registration.show', $req->id) }}"
                                   class="text-purple-600 hover:text-purple-900 font-semibold">
                                    Lihat Detail
                                </a>
                                @if($req->status === 'selesai')
                                <a href="{{ route('user.vpn.registration.survey', $req->id) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-4 py-8 text-center text-gray-500">
                                Belum ada permohonan pendaftaran VPN.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
