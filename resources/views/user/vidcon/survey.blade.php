...
<div class="max-w-7xl mx-auto">
  <div class="mb-6">
    <div class="flex items-center justify-between mb-4">
      <div>
        <h1 class="text-2xl font-bold text-purple-700">Survey Kepuasan Layanan Fasilitasi Rapat Virtual / Webinar / Streaming</h1>
    ...
    <div class="bg-blue-50 border-l-4 border-blue-500 p-4 rounded mb-4">
      <p class="text-sm text-blue-800">
        <strong>Mohon luangkan waktu Anda</strong> untuk memberikan penilaian terhadap layanan fasilitasi video conference yang telah Anda terima.
