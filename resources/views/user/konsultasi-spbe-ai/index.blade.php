            ...
            <div>
                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    @if (!empty($hasAccessed))
                        <a href="{{ route('user.konsultasi-spbe-ai.survey') }}"
                           class="inline-flex items-center px-6 py-4 bg-amber-500 hover:bg-amber-600 text-white font-bold rounded-lg shadow-lg transform transition duration-200 hover:scale-105">
