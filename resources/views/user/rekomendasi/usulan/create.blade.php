...
<style>
/* ============================================================
   Redesain Form Usulan Rekomendasi Aplikasi — modern & rapi
   Semua style diberi prefix .usulan-redesign agar tidak
   bocor / memengaruhi halaman lain.
   ============================================================ */
...
.usulan-redesign .step-content > h2 {
...
.usulan-redesign .uf-section__icon {
    ...
    box-shadow:0 6px 14px -6px rgba(15,42,86,.4);
}
...
.usulan-redesign textarea:not(.editor-field) {
    ...
    box-shadow:0 1px 1px rgba(15,42,86,.03);
}
...
.usulan-redesign .uf-check {
    ...
    border:1px solid #d6dde8; border-radius:.65rem;
    padding:.55rem .9rem; cursor:pointer; user-select:none; font-size:.88rem;
    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="uf-hero mb-7">
            <div class="flex items-start gap-3">
                ...
                <div>
                    <h1>Buat Usulan Rekomendasi Aplikasi Baru</h1>
                    <p>Lengkapi formulir bertahap di bawah ini untuk mengajukan usulan rekomendasi aplikasi.</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="uf-section__body">
                        <div class="uf-grid">
                            ...
                            <div class="uf-field">
                                ...
                                <textarea id="deskripsi" name="deskripsi" rows="4" class="editor-field">{{ old('deskripsi') }}</textarea>
                            ...
                            <div class="uf-field">
                                ...
                                <textarea id="tujuan" name="tujuan" rows="3" class="editor-field">{{ old('tujuan') }}</textarea>
                            ...
                            <div class="uf-field">
                                ...
                                <textarea id="manfaat" name="manfaat" rows="3" class="editor-field">{{ old('manfaat') }}</textarea>
                        ...
                        <div class="uf-grid uf-grid-2">
                            ...
                            <div class="uf-field">
                                ...
                                <select id="pemilik_proses_bisnis_id" name="pemilik_proses_bisnis_id" required>
                                    ...
                                    @foreach($unitKerjaList as $uk)
                                        <option value="{{ $uk->id }}" {{ old('pemilik_proses_bisnis_id') == $uk->id ? 'selected' : '' }}>{{ $uk->nama }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="uf-field">
                                ...
                                <select id="jenis_layanan" name="jenis_layanan" required>
                                    ...
                                    <option value="internal" {{ old('jenis_layanan') == 'internal' ? 'selected' : '' }}>Layanan Administrasi Pemerintahan</option>
                                </select>
                            ...
                            <div class="uf-field">
                                ...
                                <input type="text" id="estimasi_pengguna_display"
                                    ...
                                    required>
                                <input type="hidden" id="estimasi_pengguna" name="estimasi_pengguna" value="{{ old('estimasi_pengguna') }}">
                        ...
                        <div class="uf-grid uf-grid-2">
                            ...
                            <div class="uf-field uf-col-full">
                                ...
                                <div class="flex flex-wrap gap-2.5">
                                    <label class="uf-check">
                                        <input type="checkbox" name="platform[]" value="web" {{ in_array('web', old('platform', [])) ? 'checked' : '' }}>
                                        <span>🌐 Web</span>
                                    </label>
                                    <label class="uf-check">
                                        <input type="checkbox" name="platform[]" value="mobile" {{ in_array('mobile', old('platform', [])) ? 'checked' : '' }}>
                                        <span>📱 Mobile</span>
                                    </label>
                                    <label class="uf-check">
                                        <input type="checkbox" name="platform[]" value="desktop" {{ in_array('desktop', old('platform', [])) ? 'checked' : '' }}>
                                        <span>💻 Desktop</span>
                                    </label>
                                </div>
                            ...
                            <div class="uf-field">
                                ...
                                <input type="number" id="estimasi_waktu_pengembangan" name="estimasi_waktu_pengembangan"
                                    value="{{ old('estimasi_waktu_pengembangan') }}" min="1" placeholder="Contoh: 6" required>
                        ...
                        <div class="uf-grid uf-grid-2">
                            ...
                            <div class="uf-field">
                                ...
                                <input type="text" id="estimasi_biaya_display"
                                    ...
                                    required>
                                <input type="hidden" id="estimasi_biaya" name="estimasi_biaya" value="{{ old('estimasi_biaya') }}">
                ...
                <div class="uf-section">
                    ...
                    <div class="uf-section__body">
                        <div class="uf-grid uf-grid-2">
                            ...
                            <div id="detail-integrasi-wrapper" class="uf-field uf-col-full" style="display: {{ old('integrasi_sistem_lain') == 'ya' ? 'block' : 'none' }}">
                                <label for="detail_integrasi" class="uf-label">Detail Sistem yang Akan Diintegrasikan</label>
                                <textarea id="detail_integrasi" name="detail_integrasi" rows="3" class="editor-field">{{ old('detail_integrasi') }}</textarea>
                            </div>
                            ...
                            <div class="uf-field uf-col-full">
                                ...
                                <textarea id="kebutuhan_khusus" name="kebutuhan_khusus" rows="3" class="editor-field">{{ old('kebutuhan_khusus') }}</textarea>
                            </div>

                            <!-- Dampak Jika Tidak Dibangun -->
                            <div class="uf-field uf-col-full">
                                <label for="dampak_tidak_dibangun" class="uf-label">Dampak Jika Tidak Dibangun</label>
                                <textarea id="dampak_tidak_dibangun" name="dampak_tidak_dibangun" rows="3" class="editor-field">{{ old('dampak_tidak_dibangun') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="uf-section__body">
                        <div class="space-y-4">
                            ...
                            <div class="uf-field">
                                ...
                                <textarea id="dasar_hukum" name="dasar_hukum" rows="4" class="editor-field">{{ old('dasar_hukum') }}</textarea>
                            ...
                            <div class="uf-field">
                                ...
                                <textarea id="uraian_permasalahan" name="uraian_permasalahan" rows="4" class="editor-field">{{ old('uraian_permasalahan') }}</textarea>
                            ...
                            <div class="uf-field">
                                ...
                                <textarea id="pihak_terkait" name="pihak_terkait" rows="4" class="editor-field">{{ old('pihak_terkait') }}</textarea>
                    ...
                    <div class="uf-section__body">
                        <div class="space-y-4">
                            ...
                            <div class="uf-field">
                                ...
                                <textarea id="ruang_lingkup" name="ruang_lingkup" rows="4" class="editor-field">{{ old('ruang_lingkup') }}</textarea>
                            ...
                            <div class="uf-field">
                                ...
                                <textarea id="analisis_biaya_manfaat" name="analisis_biaya_manfaat" rows="4" class="editor-field">{{ old('analisis_biaya_manfaat') }}</textarea>
