...
@section('title', '- Edit Penonaktifan/Pencabutan SPLP')
@section('header-title', 'Edit Penonaktifan / Pencabutan (SPLP)')
...
<div class="container mx-auto p-6 max-w-4xl">
    ...
    <form action="{{ route('user.splp.deactivation.update', $item->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
