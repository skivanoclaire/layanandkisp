...
@section('title', '- Edit Uji Coba Sandbox SPLP')
@section('header-title', 'Edit Permohonan Uji Coba (Sandbox)')
...
<div class="container mx-auto p-6 max-w-4xl">
    ...
    <form action="{{ route('user.splp.sandbox.update', $item->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
