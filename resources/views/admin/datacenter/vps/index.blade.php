...
@section('title', '- Kelola VPS/VM')
@section('header-title', 'Kelola VPS/VM')

@section('content')
<div class="container mx-auto px-4">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-purple-700">Kelola Permohonan VPS/VM</h1>
    </div>
    ...
    <div class="mb-6 bg-white rounded-lg shadow-md p-4">
        <form method="GET" action="{{ route('admin.datacenter.vps.index') }}" class="flex gap-4 items-end">
            <div class="flex-1">
            ...
            <a href="{{ route('admin.datacenter.vps.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded font-semibold">
                Reset
            </a>
        </form>
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 text-sm text-gray-900">
                        {{ $item->vcpu }} vCPU, {{ $item->ram_gb }} GB RAM<br>
                        <span class="text-xs text-gray-500">{{ $item->storage_gb }} GB Storage</span>
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                        <a href="{{ route('admin.datacenter.vps.show', $item) }}"
