...
@section('title', '- Kelola Cloud Storage')
@section('header-title', 'Kelola Cloud Storage')

@section('content')
<div class="container mx-auto px-4">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-purple-700">Kelola Permohonan Cloud Storage</h1>
    </div>
    ...
    <div class="mb-6 bg-white rounded-lg shadow-md p-4">
        <form method="GET" action="{{ route('admin.datacenter.cloud-storage.index') }}" class="flex gap-4 items-end">
            <div class="flex-1">
            ...
            <a href="{{ route('admin.datacenter.cloud-storage.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded font-semibold">
                Reset
            </a>
        </form>
    </div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                        <a href="{{ route('admin.datacenter.cloud-storage.show', $item) }}"
                ...
                <tr>
                    <td colspan="5" class="px-6 py-8 text-center text-gray-500">
                        Tidak ada permohonan cloud storage.
                    </td>
                </tr>
                @endforelse
            </tbody>
