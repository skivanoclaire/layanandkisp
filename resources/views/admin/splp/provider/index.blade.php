...
@section('title', '- Kelola Endpoint Penyedia SPLP')
@section('header-title', 'Kelola Permohonan — Endpoint Penyedia (SPLP)')

@section('content')
<div class="container mx-auto p-6">
    <h1 class="text-2xl font-bold text-gray-800 mb-1">Pendaftaran Endpoint Penyedia (V1)</h1>
    <p class="text-gray-600 mb-6">Verifikasi & proses permohonan pendaftaran endpoint penyedia layanan.</p>
    ...
    <form method="GET" class="bg-white rounded-lg shadow-sm border p-4 mb-4 flex flex-wrap items-end gap-3">
        ...
        <a href="{{ route('admin.splp.provider.index') }}" class="px-4 py-2 rounded-lg text-sm text-gray-600 hover:bg-gray-100">Reset</a>
    </form>
                ...
                @forelse ($items as $item)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-center">
                            <a href="{{ route('admin.splp.provider.show', $item->id) }}" class="text-blue-600 hover:underline">Detail</a>
                        </td>
                    </tr>
                @empty
