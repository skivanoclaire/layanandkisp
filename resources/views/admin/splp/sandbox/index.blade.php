...
@section('title', '- Kelola Uji Coba Sandbox SPLP')
@section('header-title', 'Kelola Permohonan — Uji Coba Sandbox (SPLP)')

@section('content')
<div class="container mx-auto p-6">
    <h1 class="text-2xl font-bold text-gray-800 mb-1">Uji Coba / Sandbox (V3)</h1>
    <p class="text-gray-600 mb-6">Verifikasi & siapkan lingkungan sandbox sementara.</p>
    ...
    <form method="GET" class="bg-white rounded-lg shadow-sm border p-4 mb-4 flex flex-wrap items-end gap-3">
        ...
        <a href="{{ route('admin.splp.sandbox.index') }}" class="px-4 py-2 rounded-lg text-sm text-gray-600 hover:bg-gray-100">Reset</a>
    </form>
        ...
        <table class="min-w-full text-sm">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">Layanan Diuji</th>
                    <th class="px-4 py-3 text-left">Pemohon</th>
                    <th class="px-4 py-3 text-left">Masa Uji</th>
            ...
            <tbody class="divide-y">
                @forelse ($items as $item)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3">{{ $item->masa_uji_hari }} hari</td>
                        ...
                        <td class="px-4 py-3 text-center"><a href="{{ route('admin.splp.sandbox.show', $item->id) }}" class="text-blue-600 hover:underline">Detail</a></td>
                    </tr>
                @empty
