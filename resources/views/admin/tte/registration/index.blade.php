...
@section('title', '- Kelola Pendaftaran Akun TTE')
@section('header-title', 'Kelola Pendaftaran Akun TTE')

@section('content')
<div class="container mx-auto px-4">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Kelola Permohonan Pendaftaran Akun TTE</h1>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-4 mb-6">
        <form method="GET" action="{{ route('admin.tte.registration.index') }}" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="flex items-end gap-2">
                    ...
                    <a href="{{ route('admin.tte.registration.index') }}" class="bg-gray-400 hover:bg-gray-500 text-white px-4 py-2 rounded font-semibold text-center">
                        Reset
                    </a>
                </div>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-4 mb-4">
        <div class="flex justify-end gap-3">
            <a href="{{ route('admin.tte.registration.export-excel', request()->query()) }}"
            ...
            <a href="{{ route('admin.tte.registration.export-pdf', request()->query()) }}"
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 text-sm font-medium">
                            <a href="{{ route('admin.tte.registration.show', $request) }}" class="text-blue-600 hover:text-blue-900 mr-3">
                                Detail
                            </a>
                            <form action="{{ route('admin.tte.registration.destroy', $request) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
                    ...
                    <tr>
                        <td colspan="7" class="px-6 py-4 text-center text-gray-500">
                            Belum ada permohonan pendaftaran akun TTE.
                        </td>
                    </tr>
                    @endforelse
                </tbody>
