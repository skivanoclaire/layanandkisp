...
<head>
    <meta charset="utf-8">
    <title>Data Permohonan Pembaruan Sertifikat TTE</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>Data Permohonan Pembaruan Sertifikat TTE</h1>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $request->nama }}</td>
                <td>{{ $request->nip }}</td>
                <td>{{ $request->email_resmi }}</td>
                <td>{{ $request->nomor_sertifikat_lama ?? '-' }}</td>
                <td>
