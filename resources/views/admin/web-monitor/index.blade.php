...
<div class="container mx-auto p-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <div class="flex gap-3 mb-4">
            ...
            <a href="{{ route('admin.web-monitor.traffic-report') }}"
            ...
            <table id="monitorTable" class="min-w-full table-auto border-collapse">
                <thead>
                    <tr class="bg-gray-100">
                        ...
                        <th class="border border-gray-300 px-4 py-3 text-left">Nama Sistem</th>
                        <th class="border border-gray-300 px-4 py-3 text-left">Subdomain</th>
                        <th class="border border-gray-300 px-4 py-3 text-center">Status ESC</th>
                        <th class="border border-gray-300 px-4 py-3 text-center">Status DC</th>
                        ...
                        <th class="border border-gray-300 px-4 py-3 text-center">TTE</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="border border-gray-300 px-4 py-2">
                            <div class="flex flex-col gap-2">
                                <a href="{{ route('admin.web-monitor.generate-tte-pdf', $item) }}"
                                   target="_blank"
                                   class="text-center bg-blue-500 hover:bg-blue-600 text-white text-xs px-3 py-1.5 rounded transition whitespace-nowrap">
                                    📄 Preview
                                </a>
                                <a href="{{ route('admin.web-monitor.download-tte-pdf', $item) }}"
                                   class="text-center bg-green-500 hover:bg-green-600 text-white text-xs px-3 py-1.5 rounded transition whitespace-nowrap">
                                    ⬇️ Download
                                </a>
                            </div>
                        </td>
