...
@section('title', '- Admin: Pendaftaran VPN')
@section('header-title', 'Admin: Pendaftaran VPN')

@section('content')
<div class="container mx-auto px-4 max-w-7xl">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-purple-700">Kelola Pendaftaran VPN</h1>
    </div>

    <!-- Search & Filter -->
    <div class="bg-white rounded-lg shadow-md p-4 mb-6">
        <form method="GET" action="{{ route('admin.vpn.registration.index') }}" class="flex flex-wrap gap-4">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-purple-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase">Tipe VPN</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($requests as $req)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap">
                                <a href="{{ route('admin.vpn.registration.show', $req->id) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-4 py-8 text-center text-gray-500">
                                Tidak ada permohonan pendaftaran VPN.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
