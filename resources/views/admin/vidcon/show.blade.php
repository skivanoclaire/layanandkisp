...
<div class="container mx-auto px-4 max-w-5xl">
    <div class="mb-6 flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('admin.vidcon.detail-pdf', $item->id) }}"
               class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded font-semibold inline-flex items-center gap-2">
