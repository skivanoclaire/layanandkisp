...
<div class="container mx-auto px-4">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex gap-2">
            <a href="{{ route('admin.google-aset-tik.hardware.export-csv', request()->query()) }}"
               class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded font-semibold inline-flex items-center gap-1"
               title="Unduh seluruh data (sesuai filter) sebagai CSV — ringan untuk data besar">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                </svg>
                Export Excel/CSV
            </a>
            <a href="{{ route('admin.google-aset-tik.hardware.export-pdf', request()->query()) }}" target="_blank"
               class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded font-semibold inline-flex items-center gap-1"
               title="Cetak PDF — sebaiknya gunakan filter dulu agar tidak berat">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                </svg>
                Export PDF
