...
@section('title', '- Tambah Data Vidcon')
@section('header-title', 'Tambah Data Vidcon')

@section('content')
<div class="container mx-auto px-4">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Tambah Data Fasilitasi Video Konferensi</h1>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('admin.vidcon-data.store') }}" method="POST" enctype="multipart/form-data">
            @csrf

            <div class="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6">
                <p class="text-sm text-blue-700">
                    <strong>Info:</strong> Nomor urut akan digenerate otomatis oleh sistem.
                </p>
            </div>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_pemohon" value="{{ old('nama_pemohon') }}" class="w-full border-gray-300 rounded-md shadow-sm @error('nama_pemohon') border-red-500 @enderror" required>
                        @error('nama_pemohon')
                    ...
                    <div>
                        ...
                        <input type="text" name="nip_pemohon" value="{{ old('nip_pemohon') }}" class="w-full border-gray-300 rounded-md shadow-sm @error('nip_pemohon') border-red-500 @enderror" required>
                        @error('nip_pemohon')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="email" name="email_pemohon" value="{{ old('email_pemohon') }}" class="w-full border-gray-300 rounded-md shadow-sm @error('email_pemohon') border-red-500 @enderror" required>
                        @error('email_pemohon')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="no_hp" value="{{ old('no_hp') }}" class="w-full border-gray-300 rounded-md shadow-sm @error('no_hp') border-red-500 @enderror" placeholder="08xxxxxxxxxx" required>
                        @error('no_hp')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="nomor_surat" value="{{ old('nomor_surat') }}" class="w-full border-gray-300 rounded-md shadow-sm @error('nomor_surat') border-red-500 @enderror">
                        @error('nomor_surat')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="judul_kegiatan" value="{{ old('judul_kegiatan') }}" class="w-full border-gray-300 rounded-md shadow-sm @error('judul_kegiatan') border-red-500 @enderror" required>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="deskripsi_kegiatan" rows="4" class="w-full border-gray-300 rounded-md shadow-sm @error('deskripsi_kegiatan') border-red-500 @enderror" placeholder="Jelaskan detail kegiatan yang akan dilaksanakan">{{ old('deskripsi_kegiatan') }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="text" name="lokasi" value="{{ old('lokasi', 'Online') }}" class="w-full border-gray-300 rounded-md shadow-sm @error('lokasi') border-red-500 @enderror">
                        @error('lokasi')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="jumlah_peserta" value="{{ old('jumlah_peserta') }}" class="w-full border-gray-300 rounded-md shadow-sm @error('jumlah_peserta') border-red-500 @enderror" min="1">
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_mulai" id="tanggal_mulai" value="{{ old('tanggal_mulai') }}" class="w-full border-gray-300 rounded-md shadow-sm @error('tanggal_mulai') border-red-500 @enderror" required>
                        @error('tanggal_mulai')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_selesai" id="tanggal_selesai" value="{{ old('tanggal_selesai') }}" class="w-full border-gray-300 rounded-md shadow-sm @error('tanggal_selesai') border-red-500 @enderror" required>
                    ...
                    <div>
                        ...
                        <input type="time" name="jam_mulai" value="{{ old('jam_mulai') }}" class="w-full border-gray-300 rounded-md shadow-sm @error('jam_mulai') border-red-500 @enderror" required>
                        @error('jam_mulai')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="time" name="jam_selesai" value="{{ old('jam_selesai') }}" class="w-full border-gray-300 rounded-md shadow-sm @error('jam_selesai') border-red-500 @enderror" required>
                        @error('jam_selesai')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <select name="platform" id="platform" class="w-full border-gray-300 rounded-md shadow-sm @error('platform') border-red-500 @enderror" required>
                            ...
                            <option value="Cisco Webex" {{ old('platform') == 'Cisco Webex' ? 'selected' : '' }}>Cisco Webex</option>
                    ...
                    <div id="platform_lainnya_wrapper" style="display: {{ old('platform') == 'Lainnya' ? 'block' : 'none' }};">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Sebutkan Platform Lainnya</label>
                        <input type="text" name="platform_lainnya" value="{{ old('platform_lainnya') }}" class="w-full border-gray-300 rounded-md shadow-sm @error('platform_lainnya') border-red-500 @enderror" placeholder="Nama platform">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="keperluan_khusus" rows="3" class="w-full border-gray-300 rounded-md shadow-sm @error('keperluan_khusus') border-red-500 @enderror" placeholder="Contoh: Breakout rooms, recording, live streaming, dll.">{{ old('keperluan_khusus') }}</textarea>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="link_meeting" value="{{ old('link_meeting') }}" class="w-full border-gray-300 rounded-md shadow-sm @error('link_meeting') border-red-500 @enderror" placeholder="https://...">
                        @error('link_meeting')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="meeting_id" value="{{ old('meeting_id') }}" class="w-full border-gray-300 rounded-md shadow-sm @error('meeting_id') border-red-500 @enderror" placeholder="123 456 7890">
                        @error('meeting_id')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="meeting_password" value="{{ old('meeting_password') }}" class="w-full border-gray-300 rounded-md shadow-sm @error('meeting_password') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="text" name="dokumentasi" value="{{ old('dokumentasi') }}" class="w-full border-gray-300 rounded-md shadow-sm @error('dokumentasi') border-red-500 @enderror" placeholder="Link dokumentasi">
                        @error('dokumentasi')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="informasi_tambahan" rows="3" class="w-full border-gray-300 rounded-md shadow-sm @error('informasi_tambahan') border-red-500 @enderror" placeholder="Informasi tambahan terkait meeting">{{ old('informasi_tambahan') }}</textarea>
                            ...
                            @forelse($operators as $operator)
                                <label class="flex items-center py-2 hover:bg-gray-50 cursor-pointer operator-item" data-operator-id="{{ $operator->id }}">
                                    <input type="checkbox" name="operators[]" value="{{ $operator->id }}"
                                        {{ in_array($operator->id, old('operators', [])) ? 'checked' : '' }}
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <select name="akun_zoom" id="akun_zoom" class="w-full border-gray-300 rounded-md shadow-sm @error('akun_zoom') border-red-500 @enderror">
                            ...
                            <option value="001" {{ old('akun_zoom') == '001' ? 'selected' : '' }}>Akun 001</option>
                            <option value="002" {{ old('akun_zoom') == '002' ? 'selected' : '' }}>Akun 002</option>
                            <option value="003" {{ old('akun_zoom') == '003' ? 'selected' : '' }}>Akun 003</option>
                            <option value="004" {{ old('akun_zoom') == '004' ? 'selected' : '' }}>Akun 004</option>
                        </select>
                        @error('akun_zoom')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <textarea name="informasi_pimpinan" rows="3" class="w-full border-gray-300 rounded-md shadow-sm @error('informasi_pimpinan') border-red-500 @enderror">{{ old('informasi_pimpinan') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="keterangan" rows="3" class="w-full border-gray-300 rounded-md shadow-sm @error('keterangan') border-red-500 @enderror">{{ old('keterangan') }}</textarea>
                        @error('keterangan')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <input type="hidden" name="operator" value="{{ old('operator') }}">
    ...
    function checkZoomAccountConflict() {
        ...
        fetch('{{ route("admin.vidcon-data.check-zoom-conflict") }}', {
            ...
            body: JSON.stringify({
                ...
                exclude_id: null // For create mode
            })
        })
