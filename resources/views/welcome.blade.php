                            ...
                            @switch($item['slug'])
                                @case('rekomendasi')
                                    ...
                                    <ol class="list-decimal ml-5 space-y-1">
                                        ...
                                        <li>
                                            <a href="https://docs.google.com/document/d/1W4dnFBotESNRp1fCUj-Ob6wUiUiqK0Dg/edit?usp=sharing&ouid=107712972640306722151&rtpof=true&sd=true"
                                                class="text-blue-600 underline hover:text-blue-800">📌 Download Contoh Dokumen
                                ...
                                @case('subdomain')
                                    <p>
                                        ...
                                        <br>
                                        <a href="https://docs.google.com/document/d/1fqC1F4Fe6u4-iVJ1sa2ZSHj1ltl9GIeV/edit?usp=sharing&ouid=107712972640306722151&rtpof=true&sd=true"
                                            class="text-blue-600 underline hover:text-blue-800">Download Format Permohonan</a>
                                    </p>
                                    <p><b>PSE</b><br>
                                ...
                                @case('email')
                                    <p class="text-justify text-gray-800 leading-relaxed mb-4">
                                        ...
                                        dapat mengisi secara online (login pada aplikasi e-Layanan) atau menyiapkan surat permohonan
                                        yang
                                    ...
                                    <p class="text-justify text-gray-800 leading-relaxed mb-4">
                                        Berdasarkan data di atas, selanjutnya tim teknis Dinas KISP Prov. Kaltara memeriksa dan
                                        memverifikasi
                                        kelengkapan berkas. Jika lengkap, tim teknis akan membuat akun email sesuai dengan
                                        permohonan dan
                                ...
                                @case('tte')
                                    <div class="space-y-4 text-gray-800">
                                        ...
                                        <ol class="list-decimal ml-5 space-y-1">
                                            <li>Buka <a href="http://linktr.ee/layanansandikaltara" class="text-blue-600 underline"
                                                    target="_blank">http://linktr.ee/layanansandikaltara</a> dan isi seluruh form
                                            </li>
                                            <li>Konfirmasi ke verifikator via WA (<a href="https://wa.me/6281350042338"
                                                    class="text-blue-600 underline" target="_blank">081350042338</a>)</li>
                                            <li>Setelah mendapat info dari verifikator akun telah didaftarkan, cek email (<a
                                                    href="https://webmail.kaltaraprov.go.id" class="text-blue-600 underline"
                                                    target="_blank">webmail.kaltaraprov.go.id</a>) untuk aktivasi akun</li>
