...
@section('content')
    <div class="max-w-7xl mx-auto p-4">
        <h1 class="text-2xl font-semibold mb-4">Laporan Statistik Video Konferensi</h1>

        <div class="rounded-lg overflow-hidden shadow bg-white">
            <div class="aspect-video w-full">
                <iframe width="900" height="675"
                    src="https://lookerstudio.google.com/embed/reporting/f610feda-9bba-4275-a674-78d41b9c8ab8/page/p_mph1doas9c"
